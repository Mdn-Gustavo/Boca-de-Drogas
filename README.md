# Drug Den — Management System

Academic project developed as an evaluative activity, simulating a fictional and humorous inventory and sales management system.

## About the Project

**Drug Den** (Boca de Drogas) is a management system developed in **C#** that allows you to register products, control inventory, track customers, record sales, and manage debts—all via the terminal (console).
